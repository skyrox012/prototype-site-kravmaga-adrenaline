<template>
  <Head>
    ...
    <meta
      ...
      content="Rejoignez notre club de Krav Maga ! Remplissez notre formulaire d'inscription et commencez votre entraînement en self-défense."
    />
    <meta
      property="og:image"
    ...
    <meta
      property="og:url"
      content="https://prototype-site-kravmaga-adrenaline.vercel.app/inscription"
    />
  </Head>
  ...
  <section class="bg-[#030806] text-[#F8F5F7] min-h-screen font-mulish bg-fixed" style="
    ...
    <div v-scroll-animation class="mx-auto px-4 text-center relative py-16">
      ...
      <div class="relative z-10">
        ...
        <p class="text-lg md:text-xl font-mulish text-gray-300">
          Rejoignez notre club et commencez votre parcours dans l'art de
          l'autodéfense.
        </p>
      </div>
    </div>
    ...
    >
      <form v-scroll-animation class="max-w-3xl mx-auto py-6">
        ...
        <div class="py-6 mb-8">
          <div
            class="p-4 bg-[#101010] border-2 border-[#3A3A25] hover:border-[#D20000] transition-colors mb-6"
          >
            <label class="flex items-center cursor-pointer">
              <input
                type="checkbox"
                class="w-5 h-5 accent-[#D20000]"
                id="trial"
              />
              <span class="text-lg text-gray-300 px-3"
                >Je souhaite suivre une séance d'essai</span
              >
            </label>
            <p class="text-gray-400 mt-2 ml-8">
              Je souhaite suivre une séance d'essai pour voir si cela me
              convient avant de m'inscrire
            </p>
          </div>

          <div
            class="p-4 bg-[#101010] border-2 border-[#3A3A25] hover:border-[#D20000] transition-colors"
          >
            <label class="flex items-center cursor-pointer">
              <input
                type="checkbox"
              ...
              />
              <span class="text-lg text-gray-300 px-3"
                >Je souhaite créer mon compte</span
              >
            </label>
            <p class="text-gray-400 mt-2 ml-8">
              Je souhaite créer mon compte pour suivre régulièrement les cours
            </p>
          </div>
        </div>
        ...
        <div class="pb-6">
          ...
          <input
            ...
            required
            class="w-full bg-[#101010] border-2 border-[#3A3A25] p-3 text-white focus:border-[#D20000] focus:outline-none transition-colors"
            placeholder="Lieu de préférence"
          />
        </div>
        ...
        <button
          type="submit"
          class="w-full bg-[#D20000] text-white px-8 py-4 my-6 text-lg font-bold transform transition-all duration-300 hover:scale-105 hover:bg-red-700 hover:shadow-red-500/30 hover:shadow-lg"
        >
          Créer mon compte
        </button>
      </form>
